...
public class MenuItemTest extends Application {
 Canvas canvas;
 RadioMenuItem rectItem;
 RadioMenuItem circleItem;
 RadioMenuItem ellipseItem;
 CheckMenuItem strokeItem;
 Slider strokeWidthSlider;
 CustomMenuItem strokeWidthItem;
 ...
 public void start(Stage stage) {
     ...
     rectItem = new RadioMenuItem("_Rectangle");
     circleItem = new RadioMenuItem("_Circle");
     ellipseItem = new RadioMenuItem("_Ellipse");
     // A menu item to draw stroke
     strokeItem = new CheckMenuItem("Draw _Stroke");
     // To adjust the stroke width
     strokeWidthSlider = new Slider(1, 10, 1);
     strokeWidthItem = new CustomMenuItem(strokeWidthSlider, false);
 ...
 public Menu getFileMenu() {
     ...
     fileMenu.getItems().addAll(rectItem, circleItem, ellipseItem, new SeparatorMenuItem(), clearItem, new SeparatorMenuItem(), exitItem);
     return fileMenu;
 }
 ...
 public void strokeWidthChanged(ObservableValue<? extends Number> prop, Number oldValue, Number newValue) {
     draw();
 }
